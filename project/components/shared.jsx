...
const T = {
  it: {
    ...
    newsletter_sub: "Resta aggiornato su mostre, residenze e iniziative del Complesso e di Lavoro per la Persona. L'iscrizione avviene tramite il sito di Lavoro per la Persona.",
    subscribe: "Iscriviti →",
  ...
  en: {
    ...
    newsletter_sub: "Stay updated on exhibitions, residencies and events at the Complesso and Lavoro per la Persona. Sign-up is handled through the Lavoro per la Persona website.",
    subscribe: "Subscribe →",
