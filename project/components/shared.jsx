...
const T = {
  it: {
    ...
    nl_name: "Nome e Cognome *",
    nl_email: "Email *",
    nl_phone: "Cellulare",
    nl_city: "Città",
    nl_job: "Professione",
    nl_privacy_pre: "Ho letto l'",
    nl_privacy_link_text: "informativa privacy",
    nl_privacy_post: " e acconsento all'iscrizione alla newsletter",
    nl_privacy_url: "https://www.lavoroperlapersona.it/informativa-privacy-ue-n-679-2016/",
    nl_send: "Iscriviti",
    nl_sending: "Invio in corso…",
    nl_ok: "Iscrizione completata. Grazie!",
    nl_err: "Si è verificato un errore. Riprova più tardi.",
    nl_err_spam: "Verifica anti-spam fallita. Riprova.",
    nl_required: "Compila nome, email e accetta la privacy.",
  ...
  en: {
    ...
    nl_city: "City",
    nl_job: "Profession",
    nl_privacy_pre: "I have read the ",
    nl_privacy_link_text: "privacy policy",
    nl_privacy_post: " and consent to newsletter subscription",
    nl_privacy_url: "https://www.lavoroperlapersona.it/informativa-privacy-ue-n-679-2016/",
    nl_send: "Subscribe",
    nl_sending: "Sending…",
    nl_ok: "Subscription complete. Thank you!",
    nl_err: "An error occurred. Please try again later.",
    nl_err_spam: "Anti-spam check failed. Please try again.",
    nl_required: "Please fill in name, email and accept the privacy policy.",
